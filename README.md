...
<p align="center">
  ...
  <img alt="Windows" src="https://img.shields.io/badge/platform-Windows-2f3549?style=flat-square">
  <a href="LICENSE"><img alt="MIT" src="https://img.shields.io/github/license/simnJS/hangar-ai?style=flat-square&color=2f3549"></a>
</p>

## Download

**[Get the latest release](https://github.com/simnJS/hangar-ai/releases/latest)** — `.exe` or
`.msi`, 64-bit Windows. WebView2 is required and ships with Windows 11.
...
- **Tiling panes** — 1, 2, 4 or 8 real terminals. Every split resizes on its own, and each
  pane picks its shell from whatever is installed: PowerShell, cmd, Git Bash, WSL, MSYS2,
  Nushell.
...
Everything else is rebindable from Settings → Shortcuts.

## Development

Node 20+, pnpm and a Rust toolchain; on Windows, the MSVC build tools.
...
Redrawing the logo regenerates three checked-in copies, in this order:
